...
public class TUserBaseInfoBo {
	...
	private String userStatus;	//启停状态
	...
	public String toString() {
		return "TUserBaseInfoVo [userNo=" + userNo + ", userLoginName=" + userLoginName + ", userName=" + userName + ", userType=" + userType + ", userRole=" + userRole
				...
				+ ", superUserNo=" + superUserNo + ", insertDate=" + insertDate + ", updateDate=" + updateDate + ", registerStatus=" + registerStatus + ", gradeNo=" + gradeNo + "]";
	}
}
